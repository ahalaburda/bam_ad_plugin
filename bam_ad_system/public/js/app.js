...
//First get the data from the span using the id, then convert everthing to integer, next milliseconds, add all the data with the current day
...
var x = setInterval(function() {
	...
	// Output the result in an clock section
